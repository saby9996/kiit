						...
						while($events->have_posts()){
							...
							echo '<li><strong class="title" data-id="'.get_the_ID().'"><i class="icon-pin-2"></i> [ '.(empty($start)?'':date_i18n( get_option( 'date_format' ), $start )).' ] '.get_the_title().'</strong>
	                                <ul class="data_links">
	                                    ...
	                                    <li><a class="preview" title="'.__('Preview','wplms-eventon' ).'" target="_blank"><span class="dashicons dashicons-visibility"></span></a></li>
	                                    <li><a class="remove" title="'.__('Remove','wplms-eventon' ).'"><span class="dashicons dashicons-no-alt"></span></a></li>
	                                    <li><a class="delete" title="'.__('Delete','wplms-eventon' ).'"><span class="dashicons dashicons-trash"></span></a></li>
	                                </ul>
	                            </li>';
					...
					<ul class="hide">
						<li><strong class="title" data-id=""><i class="icon-pin-2"></i> <span></span></strong>
	                        <ul class="data_links">
	                            ...
	                            <li><a class="preview" title="<?php _e('Preview','wplms-eventon' ); ?>" target="_blank"><span class="dashicons dashicons-visibility"></span></a></li>
	                            <li><a class="remove" title="<?php _e('Remove','wplms-eventon' ); ?>"><span class="dashicons dashicons-no-alt"></span></a></li>
	                            <li><a class="delete" title="<?php _e('Delete','wplms-eventon' ); ?>"><span class="dashicons dashicons-trash"></span></a></li>
	                        </ul>
	                    </li>
					</ul>
