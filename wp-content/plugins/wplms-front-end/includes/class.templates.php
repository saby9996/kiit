...
class WPLMS_Content_Templates {
	...
	function get_question_templates($type){
		...
		switch($type){
			...
			break;
			case 'select':
				$this->settings['post_content'] = __('Question Statement : Select correct answer out of the following','wplms-front-end').' [select options="1,2,3"] and another [select="4,5,6"]';
				$this->settings['meta_fields'] = array(
						'vibe_question_type'=> $type,
