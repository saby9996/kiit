...
class WPLMS_Front_End_Fields {
	...
	function create_tabs(){
		...
		$extras = apply_filters('wplms_front_end_course_extras',array(
			array(
				'label'=> '<i class="icon-send-to-back"></i>',
			...
			foreach($extras as $extra){
				echo '<li><a href="'.$extra['link'].'" title="'.$extra['title'].'">'.$extra['label'].'</a></li>';
			}
			echo '</ul>';
		}
		?>
				...
				<ul id="<?php echo $field['id']; ?>" class="wplms-taxonomy">
                    <li>
                        <select id="<?php echo $field['id']; ?>-select" class="chosen post_field" <?php echo 'data-id="'.$field['id'].'" data-taxonomy="'.$field['taxonomy'].'" data-type="'.$field['type'].'"'; ?>>
                            <option><?php echo $field['default']; ?></option>
			...
			case 'dynamic_quiz_questions':
				...
				if(!empty($field['value'])){
						...
						foreach($tags as $i=>$tag){
							...
							echo '<li><span class="dashicons dashicons-sort"></span>&nbsp;'.$tags_string.' <input type="text" value="'.$numbers[$i].'"><a class="remove_tag" title="'.__('Remove','wplms-front-end' ).'"><span class="dashicons dashicons-no-alt"></span></a></li>';
						}
				}
				?>
				</ul>
				<div class="hidden_block hide">
					...
					<input type="text" data-id="<?php echo $field['id'].'[numbers]'; ?>" value="0" />	
					<a class="remove_tag" title="'.__('Remove','wplms-front-end' ).'"><span class="dashicons dashicons-no-alt"></span></a>				
				</div>
				<?php
			break;
